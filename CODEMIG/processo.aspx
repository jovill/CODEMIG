                                                       <%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/site.master" CodeBehind="processo.aspx.cs" Inherits="Index" %>
...
<%-- DISTRITO ---------------------------------------------------------------------------------------------%>
            <div class="row" style="margin-bottom:5px;">
                ...
                <div class="col-md-4 form-group">
                    <asp:DropDownList  Style="width: 100%" ID="ddlDistritos" class=" form-control input-sm " runat="server" AppendDataBoundItems="true" autofocus="true">
            ...
            <div class="row" style="margin-bottom:5px;"> 
                ...
                <div class="col-md-4 form-group">
                    <div class="icon-addon addon-sm">
                        <asp:TextBox Style="width: 100%" type="text" placeholder="Processo" class="form-control input-sm" ID="txtProcesso" runat="server" name="processo"></asp:TextBox>
        ...
        */
        ...
        $(document).ready(function () {
            ...
            $("#<%=txtProcesso.ClientID %>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: '<%=ResolveUrl("~/Service.asmx/GetProcessos") %>',
                        data: "{ 'texto': '" + request.term + "', 'distritoCODEMIG': '" + $('#<%=ddlDistritos.ClientID%>').val() + "'}",
                        dataType: "json",
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
